...
A Versão Prévia 2 inclui uma contribuição importante de [Paul Middleton](https://github.com/pmiddleton) que permite o mapeamento funções escalares do banco de dados para o stubs de método para que possam ser usadas em consultas LINQ e convertidas em SQL.
...
Métodos assim são automaticamente registrados. Quando um método tiver sido registrado, você poderá usá-lo em qualquer lugar em suas consultas:
...
Observe que Like() vem com uma implementação em memória, que pode ser útil ao trabalhar com um banco de dados em memória ou quando a avaliação do predicado precisa ocorrer ícone no lado do cliente.
