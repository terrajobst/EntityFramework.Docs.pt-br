...
## <a name="2-cold-vs-warm-query-execution"></a>2. Frio versus Execução de consulta passiva
...
|:-----------------------------------------------------------------------------------------------------|:--------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `using(var db = new MyContext())` <br/> `{`                                                          | Criação de contexto          | Média                                                                                                                                                                                                                                                                                                                                                                                                                        | Média                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `  var q1 = ` <br/> `    from c in db.Customers` <br/> `    where c.Id == id1` <br/> `    select c;` | Criação de expressão de consulta | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                           | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `  var c1 = q1.First();`                                                                             | Execução de consulta LINQ      | -Carregamento de metadados: Alto, mas em cache <br/> -Exibição de geração: Potencialmente muito alto, mas em cache <br/> -Avaliação de parâmetro: Média <br/> -Conversão de consulta: Média <br/> -Geração de materializador: Médio, mas armazenado em cache <br/> -Execução da consulta de banco de dados: Potencialmente alto <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Média <br/> -Pesquisa de identidade: Média | -Carregamento de metadados: Alto, mas em cache <br/> -Exibição de geração: Potencialmente muito alto, mas em cache <br/> -Avaliação de parâmetro: Baixa <br/> -Conversão de consulta: Médio, mas armazenado em cache <br/> -Geração de materializador: Médio, mas armazenado em cache <br/> -Execução da consulta de banco de dados: Potencialmente alto (consultas melhores em algumas situações) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Média <br/> -Pesquisa de identidade: Média | -Carregamento de metadados: Alto, mas em cache <br/> -Exibição de geração: Médio, mas armazenado em cache <br/> -Avaliação de parâmetro: Baixa <br/> -Conversão de consulta: Médio, mas armazenado em cache <br/> -Geração de materializador: Médio, mas armazenado em cache <br/> -Execução da consulta de banco de dados: Potencialmente alto (consultas melhores em algumas situações) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Médio (mais rápido que EF5) <br/> -Pesquisa de identidade: Média |
| `}`                                                                                                  | Conexão. fechar          | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                           | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `using(var db = new MyContext())` <br/> `{`                                                          | Criação de contexto          | Média                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Média                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var q1 = ` <br/> `    from c in db.Customers` <br/> `    where c.Id == id1` <br/> `    select c;` | Criação de expressão de consulta | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var c1 = q1.First();`                                                                             | Execução de consulta LINQ      | -Pesquisa de ~~carregamento~~ de metadados: ~~Alto, mas em cache~~ Pequena <br/> -Exibir pesquisa de ~~geração~~ : ~~Potencialmente muito alto, mas em cache~~ Pequena <br/> -Avaliação de parâmetro: Média <br/> -Pesquisa de ~~conversão~~ de consulta: Média <br/> -Pesquisa de ~~geração~~ de materializador: ~~Médio, mas armazenado em cache~~ Pequena <br/> -Execução da consulta de banco de dados: Potencialmente alto <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Média <br/> -Pesquisa de identidade: Média | -Pesquisa de ~~carregamento~~ de metadados: ~~Alto, mas em cache~~ Pequena <br/> -Exibir pesquisa de ~~geração~~ : ~~Potencialmente muito alto, mas em cache~~ Pequena <br/> -Avaliação de parâmetro: Baixa <br/> -Pesquisa de ~~conversão~~ de consulta: ~~Médio, mas armazenado em cache~~ Pequena <br/> -Pesquisa de ~~geração~~ de materializador: ~~Médio, mas armazenado em cache~~ Pequena <br/> -Execução da consulta de banco de dados: Potencialmente alto (consultas melhores em algumas situações) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Média <br/> -Pesquisa de identidade: Média | -Pesquisa de ~~carregamento~~ de metadados: ~~Alto, mas em cache~~ Pequena <br/> -Exibir pesquisa de ~~geração~~ : ~~Médio, mas armazenado em cache~~ Pequena <br/> -Avaliação de parâmetro: Baixa <br/> -Pesquisa de ~~conversão~~ de consulta: ~~Médio, mas armazenado em cache~~ Pequena <br/> -Pesquisa de ~~geração~~ de materializador: ~~Médio, mas armazenado em cache~~ Pequena <br/> -Execução da consulta de banco de dados: Potencialmente alto (consultas melhores em algumas situações) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Materialização do objeto: Médio (mais rápido que EF5) <br/> -Pesquisa de identidade: Média |
| `}`                                                                                                  | Conexão. fechar          | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Baixa                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
*Observação:*  when mover seu modelo para assemblies separados Lembre-se de copiar as cadeias de conexão para o modelo no arquivo de configuração do aplicativo do projeto do cliente.
...
-   Usando IEnumerable @ no__t-0T @ no__t-1. Contém @ no__t-2 @ no__t-3 (T value).
...
### <a name="41-using-ienumerablelttgtcontainslttgtt-value"></a>4,1 usando IEnumerable @ no__t-0T @ no__t-1. Contém @ no__t-2T @ no__t-3 (valor T)

Entity Framework não armazena em cache consultas que invocam IEnumerable @ no__t-0T @ no__t-1. Contém @ no__t-2T @ no__t-3 (valor T) em relação a uma coleção na memória, pois os valores da coleção são considerados voláteis. A consulta de exemplo a seguir não será armazenada em cache, portanto, ela sempre será processada pelo compilador do plano:
...
O Entity Framework 6 contém otimizações para o caminho IEnumerable @ no__t-0T @ no__t-1. Contém @ no__t-2T @ no__t-3 (T value) funciona quando as consultas são executadas. O código SQL gerado é muito mais rápido para produzir e mais legível e, na maioria dos casos, ele também é executado mais rapidamente no servidor.
...
Neste caso de ponta a ponta, Entity Framework 6 realizações Entity Framework 5 devido a melhorias de desempenho feitas em várias partes da pilha, incluindo uma inicialização DbContext muito mais clara e MetaDataCollection mais rápidas @ no__t-0T @ no__t-1 pesquisas.
...
|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Visual Studio 2010, Entity Framework 4     | Geração de SSDL: 2 h de 27 min <br/> Geração de mapeamento: 1 segundo <br/> Geração de CSDL: 1 segundo <br/> Geração de objectlayer: 1 segundo <br/> Geração de exibição: 2 h 14 min |
...
Entity Framework, por padrão, gerará o código SQL que tem semântica de comparação nula de C @ no__t-0. Considere a seguinte consulta de exemplo:
...
Neste exemplo, estamos comparando várias variáveis anuláveis em relação às propriedades anuláveis na entidade, como CódigoDoFornecedor e UnitPrice. O SQL gerado para essa consulta perguntará se o valor do parâmetro é igual ao valor da coluna ou se os valores do parâmetro e da coluna são nulos. Isso ocultará a maneira como o servidor de banco de dados trata os valores nulos e fornecerá uma experiência de nulo C @ no__t-0 consistente entre diferentes fornecedores de banco de dados. Por outro lado, o código gerado é um pouco complicadas e pode não funcionar bem quando a quantidade de comparações na instrução WHERE da consulta cresce para um grande número.

Uma maneira de lidar com essa situação é usando a semântica nula do banco de dados. Observe que isso pode potencialmente se comportar de forma diferente com a semântica nula de C @ no__t-0 já que agora Entity Framework gerará um SQL mais simples que expõe a maneira como o mecanismo de banco de dados lida com valores nulos. A semântica nula do banco de dados pode ser ativada por contexto com uma única linha de configuração em relação à configuração de contexto:
...
Neste exemplo, a atividade do banco de dados será registrada no console do, mas a propriedade log poderá ser configurada para chamar qualquer ação @ no__t-0string @ no__t-1 delegate.
...
-   Nome do so: Windows Server 2008 R28.1 Enterprise SP1.
-   SQL Server 2008 R22012.

##### <a name="11122-hardware-environment"></a>Ambiente de hardware 11.1.2.2

-   Processador único: Intel (R) Xeon (R) CPU L5520 @ 2.27 GHz, 2261 MhzES-1620 0 @ 3,60 GHz, 4 núcleo (s), 8 processador (es) lógico (s).
-   824 GB RamRAM.
...
Em que MDF @ no__t-0SessionLogin @ no__t-1Time @ no__t-2Max () é definido no modelo como:
