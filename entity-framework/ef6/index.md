...
- Mapeamento de classes de entidade "ignoradas com persistência" (também conhecidas como "POCO", para Objeto de CLR Antigo Plano) que não dependem de nenhum dos tipos do EF
...
- Uma experiência de "Code First" compatível com a criação de modelos de entidade escrevendo código.
...
Adicione o pacote NuGet EntityFramework ao seu projeto ou instale o Entity Framework Tools para Visual Studio. Em seguida, assista a vídeos, leia tutoriais e a documentação avançada para ajudá-lo a aproveitar ao máximo o Entity Framework 6.
