...
---
# <a name="entity-framework-6-runtime-license-kor"></a>Licença de tempo de execução do Entity Framework 6 (KOR)
...
**됩니다 DA 동의하게 DO 조항들에 DE 아래의 DA 귀하는 DO 사용함으로써 DE 소프트웨어를 이. 동의하지 않을 경우에는 소프트웨어를 사용하지 마십시오.**

**본 사용권 계약을 준수하는 경우 아래와 같은 영구적 권리를 행사할 수 있습니다.**

**1. 설치 권한 DE 사용 및.** 본 소프트웨어의 사본을 수량에 관계없이 장치에 설치하여 사용할 수 있습니다.

**2. 추가 사용권 요구 사항 및/또는 사용 권한.**

-   **a. 배포 코드 de 가능.** 소프트웨어에는 귀사가 아래 조항을 준수하는 경우 귀사가 개발하는 프로그램에서 배포 권한이 부여되는 코드가 포함되어 있습니다.
    -   **i. 사용 및 배포 권한. 입니다 아래에 나열된 코드 및 파일은 "배포 가능 코드".**
...
**3. 사용권의 범위.** 본 소프트웨어는 판매되는 것이 아니라 그 사용이 허여되는 것입니다. 본 계약은 귀하에게 소프트웨어를 사용할 수 있는 권한을 허여합니다. 보유합니다 de 권한은Microsoft가 모든 기타. 이러한 제한과 관계없이 관련 법률에서 귀하에게 더 많은 권한을 부여하지 않는 한, 귀하는 본 계약에서 명시적으로 허용되는 조건에 한해서만 소프트웨어를 사용할 수 있습니다. 그렇게 하는 경우 귀하는 특정 방식으로만 사용할 수 있도록 하는 소프트웨어의 모든 기술적 제한 사항을 준수해야 합니다. 다음과 같은 행위는 허용되지 않습니다.
...
**5. 수출 제한.** 받습니다 DA 적용을 DO 규정의 DE 및 DA 법률 DO 수출 DE 미국 소프트웨어는. 귀하는 소프트웨어에 적용되는 모든 국내 및 국제 수출 법률 및 규정을 준수해야 합니다. 이러한 법률에는 목적지, 최종 사용자 및 최종 용도에 대한 제한이 포함됩니다. 자세한 내용은 www.microsoft.com/exporting 을 참조하십시오.
...
-   **b. 미국 지역 de 외.** 본 사용권 계약에는 대한민국 법이 적용됩니다.

**9. 법적 효력.** 있습니다 DA 기술하고 DO 대해 DE 권리에 DA 법적 DO 특정 DE 계약은 본. 귀하는 귀하가 거주하고 있는 국가의 법규가 보장하는 다른 권리를 보유할 수 있습니다. 또한 귀하가 소프트웨어를 구입한 당사자와 관련된 권리를 보유할 수도 있습니다. 귀하가 거주하고 있는 국가의 법에서 권리 변경을 허용하지 않는 경우 본 계약은 해당 권리를 변경하지 않습니다.
...
**11. 손해 및 구제수단의 제한 및 배제. 귀하는 직접적인 손해에 한해Microsoft와 그 공급자로부터 최대 미화 US $5 .00까지 보상받을 수 있습니다. 결과적 손해, 이익 손실, 특별, 간접 또는 부수적 손해를 포함한 기타 모든 손해에 대해서는 보상을 받을 수 없습니다.**
