...
---
# <a name="entity-framework-6-runtime-license-rus"></a>Licença de tempo de execução do Entity Framework 6 (RUS)
**УСЛОВИЯ ЛИЦЕНЗИИ НА ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ MICROSOFT**

**MICROSOFT ENTITY FRAMEWORK**

Настоящие условия лицензии являются соглашением между корпорацией Microsoft (или, в зависимости от места вашего проживания, одним из ее аффилированных лиц) и вами. ВНИМАТЕЛЬНО DE ИХ ПРОЧТИТЕ. ОНИ ПРИМЕНЯЮТСЯ К ВЫШЕУКАЗАННОМУ ПРОГРАММНОМУ ОБЕСПЕЧЕНИЮ, ВКЛЮЧАЯ НОСИТЕЛИ, НА КОТОРЫХ ОНО РАСПРОСТРАНЯЕТСЯ (ЕСЛИ ОНИ ЕСТЬ). ЭТИ УСЛОВИЯ РАСПРОСТРАНЯЮТСЯ ТАКЖЕ НА ВСЕ
...
**1.    ИСПОЛЬЗОВАНИЯ DE ПРАВА И УСТАНОВКА.** ВЫ МОЖЕТЕ УСТАНОВИТЬ И ИСПОЛЬЗОВАТЬ ЛЮБОЕ КОЛИЧЕСТВО КОПИЙ ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ НА СВОИХ УСТРОЙСТВАХ.

**2.    ДОПОЛНИТЕЛЬНЫЕ ТРЕБОВАНИЯ ЛИЦЕНЗИРОВАНИЯ И ПРАВА НА ИСПОЛЬЗОВАНИЕ.**

-   **a.    КОД DE РАСПРОСТРАНЯЕМЫЙ ВТОРИЧНО.** ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ СОДЕРЖИТ КОД, КОТОРЫЙ РАЗРЕШАЕТСЯ РАСПРОСТРАНЯТЬ В СОСТАВЕ РАЗРАБАТЫВАЕМЫХ ВАМИ ПРОГРАММ ПРИ СОБЛЮДЕНИИ ВАМИ СЛЕДУЮЩИХ УСЛОВИЙ.
    -   **Eu.      ПРАВО НА ИСПОЛЬЗОВАНИЕ И РАСПРОСТРАНЕНИЕ. ПРОГРАММНЫЙ КОД И ФАЙЛЫ, ПЕРЕЧИСЛЕННЫЕ НИЖЕ, ПРЕДСТАВЛЯЮТ СОБОЙ CENTRAL «КОД РАСПРОСТРАНЯЕМЫЙ ВТОРИЧНО CENTRAL».**
    ...
    -   **II.    УСЛОВИЯ РАСПРОСТРАНЕНИЯ. ДОЛЖНЫ DA ВЫ DO КОДА DE РАСПРОСТРАНЯЕМОГО DA ВТОРИЧНО DO ЛЮБОГО DE РАСПРОСТРАНЕНИЯ ДЛЯ:**
        -   СУЩЕСТВЕННО РАСШИРИТЬ ОСНОВНЫЕ ФУНКЦИОНАЛЬНЫЕ ВОЗМОЖНОСТИ КОДА В СВОИХ ПРОГРАММАХ;
        -   ПОТРЕБОВАТЬ ОТ ДИСТРИБЬЮТОРОВ И ВНЕШНИХ КОНЕЧНЫХ ПОЛЬЗОВАТЕЛЕЙ СОБЛЮДЕНИЯ УСЛОВИЙ, КОТОРЫЕ БУДУТ ЗАЩИЩАТЬ ВТОРИЧНО РАСПРОСТРАНЯЕМЫЙ КОД НЕ МЕНЬШЕ, СОГЛАШЕНИЕ DE ДАННОЕ ЧЕМ;
    ...
    -   **III.   ОГРАНИЧЕНИЯ РАСПРОСТРАНЕНИЯ. ВЫ ПРАВА DE ИМЕЕТЕ НЕ:**
...
-   ЛИЦАМ DA ТРЕТЬИМ DO СОГЛАШЕНИЕ DE ЭТО DA ИЛИ DO ОБЕСПЕЧЕНИЕ DE ПРОГРАММНОЕ ПЕРЕДАВАТЬ;
...
**5.    ЭКСПОРТ DE НА ОГРАНИЧЕНИЯ.** ДАННОЕ ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ ПОДПАДАЕТ ПОД ДЕЙСТВИЕ ЭКСПОРТНОГО ЗАКОНОДАТЕЛЬСТВА СОЕДИНЕННЫХ ШТАТОВ. ВЫ ОБЯЗАНЫ СОБЛЮДАТЬ ВСЕ ВНУТРЕННИЕ И МЕЖДУНАРОДНЫЕ НОРМЫ ЭКСПОРТНОГО ЗАКОНОДАТЕЛЬСТВА, ПРИМЕНИМЫЕ К ПРОГРАММНОМУ ОБЕСПЕЧЕНИЮ. К ТАКИМ ПОЛОЖЕНИЯМ ЭКСПОРТНОГО ЗАКОНОДАТЕЛЬСТВА ОТНОСЯТСЯ ОГРАНИЧЕНИЯ ПО КОНЕЧНЫМ ПОЛЬЗОВАТЕЛЯМ, ПОРЯДКУ И РЕГИОНАМ КОНЕЧНОГО ИСПОЛЬЗОВАНИЯ. СМ DE СВЕДЕНИЯ ДОПОЛНИТЕЛЬНЫЕ. На веб сайте www.microsoft.com/exporting.
...
РАСПРОСТРАНЯЕТСЯ DE ОГРАНИЧЕНИЕ ЭТО:
