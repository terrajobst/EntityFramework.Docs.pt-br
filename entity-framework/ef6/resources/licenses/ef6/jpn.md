...
---
# <a name="entity-framework-6-runtime-license-jpn"></a>Licença de tempo de execução do Entity Framework 6 (JPN)
...
-   **再頒布可能コード。 a.** 本ソフトウェアには、お客様が開発されたプログラムに含めて再頒布可能なコードが含まれています。ただし、以下の条件に従うものとします。
    -   **使用および再頒布の権利。 i.以下に記載するコードおよびファイルを「再頒布可能コード」と定義します。**
