...
- [Blog do .NET - Tag: Entity Framework](https://blogs.msdn.microsoft.com/dotnet/tag/entity-framework/)
- [Blog do ADO.NET (não mais em uso)](https://blogs.msdn.microsoft.com/adonet/)
- [Blog de Design do EF (não mais em uso)](https://blogs.msdn.microsoft.com/efdesign/)

## <a name="current-and-former-ef-team-bloggers"></a>Bloggers da equipe do EF atuais e anteriores
...
## <a name="ef-community-bloggers"></a>Blogueiros da comunidade do EF
