...
O novo recurso de resiliência de Conexão não funciona com transações iniciadas pelo usuário. Para obter detalhes, consulte [limitações com estratégias de repetição de execução](~/ef6/fundamentals/connection-resiliency/retry-logic.md#limitations).  
